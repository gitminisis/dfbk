...
export const getStatusReport = () => {
	return axios
		.post(
			'/scripts/mwimain.dll?SYSTEMCTRL',
			'USERNAME=mike&USERPASSWORD=P@$$w0rd&SITEPROFILE=&SITELANG=0&DBPROFILE=&DBLANG=0&DISMOUNTDB=&MOUNTDB=&SHOWREP=X&UNLOCKISN=&UNLOCKDB='
		)
		.then((res) => {
			let { data } = res
