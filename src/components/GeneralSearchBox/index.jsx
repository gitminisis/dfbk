...
const GeneralSearchBox = (props) => {
	...
	let databaseIndex = databaseList.findIndex(
		(e) => e.application === database
	)
							...
							<Input
								...
								startDecorator={
									<React.Fragment>
										<Select
											variant="plain"
											defaultValue={databaseList.findIndex(
												(e) => {
													return (
														e.application ===
														database
